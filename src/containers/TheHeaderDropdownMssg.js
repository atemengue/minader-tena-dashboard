    ...
    <CDropdown inNav className="c-header-nav-item mx-2" direction="down">
      ...
      <CDropdownMenu className="pt-0" placement="bottom-end">
        <CDropdownItem header tag="div" color="light">
          <strong>Vous avez{itemsCount} messages</strong>
        </CDropdownItem>
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div>
              <small className="text-muted">Regis Doe</small>
...
const mapStateToProps = ({ socketState }) => ({
  // socket: socketState.socket,
});

export default connect(mapStateToProps, {})(TheHeaderDropdownMssg);
