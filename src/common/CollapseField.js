...
const CollapseFied = ({ collapse, personnels, name = "" }) => {
              ...
              <CCol md="2" className="mt-2 mb-2">
                <CFormGroup variant="custom-checkbox" inline>
                  <CInputCheckbox
                    onChange={onCheckedField}
                    custom
                    value="Region de Travail"
                    id={`${name}regionDeTravail`}
                    name={`${name}regionDeTravail`}
                  />
                  <CLabel htmlFor="regionDeTravail" variant="custom-checkbox">
                    Region de Travail
                  </CLabel>
                </CFormGroup>
              </CCol>
              ...
              <CCol md="2" className="mt-2 mb-2">
                <CFormGroup variant="custom-checkbox" inline>
                  <CInputCheckbox
                    onChange={onCheckedField}
                    custom
                    value="Departement de Travail"
                    id={`${name}departementDeTravail`}
                    name={`${name}departementDeTravail`}
                  />
                  <CLabel
                    htmlFor="departementDeTravail"
                    variant="custom-checkbox"
                  >
              ...
              <CCol md="2" className="mt-2 mb-2">
                <CFormGroup variant="custom-checkbox" inline>
                  <CInputCheckbox
                    onChange={onCheckedField}
                    custom
                    value="Arrondissement de Travail"
                    id={`${name}arrondissementDeTravail`}
                    name={`${name}arrondissementDeTravail`}
                  />
                  <CLabel
                    htmlFor="arrondissementDeTravail"
                    variant="custom-checkbox"
                  >
              ...
              <CCol md="2" className="mt-2 mb-2">
                <CFormGroup variant="custom-checkbox" inline>
                  <CInputCheckbox
                    onChange={onCheckedField}
                    custom
                    value="Region d'origine"
                    id={`${name}regionDeOrigine`}
                    name={`${name}region`}
                  />
                  <CLabel htmlFor="regionDeOrigine" variant="custom-checkbox">
                    Region d'Origine
                  </CLabel>
                </CFormGroup>
              </CCol>
              ...
              <CCol md="2" className="mt-2 mb-2">
                <CFormGroup variant="custom-checkbox" inline>
                  <CInputCheckbox
                    onChange={onCheckedField}
                    custom
                    value="Departement d'origine"
                    id={`${name}departementDeOrigine`}
                    name={`${name}departementDeOrigine`}
                  />
                  <CLabel
                    htmlFor="departementDeOrigine"
                    variant="custom-checkbox"
                  >
              ...
              <CCol md="2" className="mt-2 mb-2">
                <CFormGroup variant="custom-checkbox" inline>
                  <CInputCheckbox
                    onChange={onCheckedField}
                    custom
                    value="Arrondissement d'origine"
                    id={`${name}arrondissementDeOrigine`}
                    name={`${name}arrondissementDeOrigine`}
                  />
                  <CLabel
                    htmlFor="arrondissementDeOrigine"
                    variant="custom-checkbox"
                  >
