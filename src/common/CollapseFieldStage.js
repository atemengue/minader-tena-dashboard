...
import ExportStagePDFExcel from "./ExportStagePDFExcel";

const CollapseFieldStage = ({ collapse, personnels, name = "" }) => {
              ...
              <CCol md="2" className="mt-2 mb-2">
                <CFormGroup variant="custom-checkbox" inline>
                  <CInputCheckbox
                    ...
                    custom
                    value="dateDebut"
                    id={`${name}dateDebutStage`}
                    name={`${name}dateDebutStage`}
                  />
                  <CLabel
                    htmlFor={`${name}dateDebutStage`}
                    variant="custom-checkbox"
                  >
              ...
              <CCol md="2" className="mt-2 mb-2">
                <CFormGroup variant="custom-checkbox" inline>
                  <CInputCheckbox
                    ...
                    custom
                    value="dateFin"
                    id={`${name}dateFinStage`}
                    name={`${name}dateFinStage`}
                  />
                  <CLabel
                    htmlFor={`${name}dateFinStage`}
                    variant="custom-checkbox"
                  >
...
export default CollapseFieldStage;
