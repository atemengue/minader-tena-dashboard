...
const ExportDecisionAffectation = ({
  fields,
  personnels,
  title,
  subtitle,
  ...
  const buildTableCertificatCollectif = (data) => {
    ...
    let header = [
      ...
      { text: "Grade", bold: true, alignment: "center", fontSize: 13 },
      {
        text: "Poste d'affectation",
        bold: true,
        alignment: "center",
        fontSize: 13,
      },
    ...
    //         fontSize: 13,
    //       },
    //       { text: "hello", style: "tableHeader", fontSize: 13 },
    //       { text: "DESA", style: "tableHeader", fontSize: 13 },
    //     ];
    //     body = [...body, array];
    //   });
    // }
  ...
  return (
    <>
      <CButton onClick={pdfDownload} size="md" color="success">
        ...
        Imprimer la decision d'affectation
      </CButton>
    </>
  );
};

export default ExportDecisionAffectation;
