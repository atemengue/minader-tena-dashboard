...
const PositionPDF = (props) => {
  ...
  const ExcelFileName = `Personnel-${props.position}.csv`;
  ...
  var docDefinition = {
    ...
    content: [
      ...
      {
        stack: [`Personnel ${props.position}`],

        style: "header",
      },
      buildTable(props.personnels, [
        "N°",
        "matricule",
        "nomsPrenoms",
        "dateNaissance",
      ...
      {
        stack: [
          `Total personnel ${props.position}:  ${props.personnels.length}`,
        ],
        style: "total",
      },
    ],
