...
import { fetchPersonnelsDecisionnaires } from "../../actions/personnelActions";
...
const PersonnelDecisionnaire = (props) => {
  useEffect(() => {
    props.fetchPersonnelsDecisionnaires();
  }, [props.fetchPersonnelsDecisionnaires]);
  return (
    <>
      <CRow>
        <CCol xs="12" sm="6" lg="3">
          <CWidgetProgress
            ...
            text="DECISIONNAIRE EN ACTIVITE"
            footer="Liste du personnel decisionnaires a partir de l'annee 2020"
          />
        </CCol>
      </CRow>
      <CRow>
      ...
      <CRow>
        <CCol xs="12" lg="12">
          <CCard>
            <CCardHeader>PERSONNEL DECISIONNAIRE EN ACTIVITÉ</CCardHeader>
            <CCardBody>
              <CDataTable
...
export default connect(mapStateToProps, { fetchPersonnelsDecisionnaires })(
  PersonnelDecisionnaire
);
