...
import ClassificationPDF from "./ClassificationPDF";
        ...
        <CCard>
          <CCardHeader className="d-flex justify-content-between">
            ...
            {props.statistique.length !== 0 && (
              <ClassificationPDF total={props.total} grille={statistique} />
            )}
          </CCardHeader>
          <CCardBody>
            <div>
...
export default connect(mapStateToProps, { getClassification })(Classification);
